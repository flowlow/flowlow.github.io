...
$(function() {
    ...
    function customUploadButton() {
        $('.js-button-file-upload-input3').on('change', function () {
            var val = $(this).val().split(/(\\|\/)/g).pop();
            if (val !== "") {
                $(".js-button-file-upload-text3")
                    .text(val)
                    .parent()
                    .removeClass("not-selected");
            } else {
...
var counter_strike = 1;
        var limit = 20;
        function addInput(dynamicInput){
        if (counter_strike == limit)  {
          alert("Vous avez atteint la limite de " + counter_strike + " ajouts");
        }
        else {
        var newdiv = document.createElement('div');
        newdiv.innerHTML = "<label style='margin-left: -14px;'>Sinistre</label> " + (counter_strike + 1) + "<select style='margin-left: 8px; margin-right: 10px;'><option>-Sélectionnez-</option><option>Dégâts des eaux</option><option>Bris de glace</option><option>Vol</option><option>Incendie</option><option>Vandalisme</option><option>Tempête</option><option>Innondation</option><option>Dommage électrique</option><option>Choc de véhicule</option><option>Autre</option></select><input id='indemnisation_h" + counter_strike + "' class='json' type='text' placeholder='Indemnisation'>";
...
var counter = 1;
        var limit = 20;
        function addInp(dynamicInp_2){
        if (counter == limit)  {
          alert("Vous avez atteint la limite de " + counter + " ajouts");
        }
        else {
        var newdiv = document.createElement('div');
        newdiv.innerHTML = "<label style='margin-left: -14px;'>Commerce n°</label> " + (counter + 1) + "<input type='text' id='surface_commerce' name='surface commerce' placeholder='surface en m²'> <input type='text' id='surface_commerce' name='surface commerce' placeholder='detail activité'>";
        document.getElementById(dynamicInp_2).appendChild(newdiv);
        counter++;
     }
...
jQuery(document).ready(function($){
	...
	$('.cd-popup5').on('click', function(event){
		if( $(event.target).is('.cd-popup-close5') || $(event.target).is('.cd-popup5') ) {
			event.preventDefault();
...
jQuery(document).ready(function($){
	...
	$('.cd-popup6').on('click', function(event){
		if( $(event.target).is('.cd-popup-close6') || $(event.target).is('.cd-popup6') ) {
			event.preventDefault();
...
jQuery(document).ready(function($){
	...
	$('.cd-popup7').on('click', function(event){
		if( $(event.target).is('.cd-popup-close7') || $(event.target).is('.cd-popup7') ) {
			event.preventDefault();
...
jQuery(document).ready(function($){
	...
	$('.cd-popup8').on('click', function(event){
		if( $(event.target).is('.cd-popup-close8') || $(event.target).is('.cd-popup8') ) {
			event.preventDefault();
...
jQuery(document).ready(function($){
	...
	$('.cd-popup9').on('click', function(event){
		if( $(event.target).is('.cd-popup-close9') || $(event.target).is('.cd-popup9') ) {
			event.preventDefault();
...
jQuery(document).ready(function($){
	...
	$('.cd-popup10').on('click', function(event){
		if( $(event.target).is('.cd-popup-close10') || $(event.target).is('.cd-popup10') ) {
			event.preventDefault();
	...
	$('.cd-popup11').on('click', function(event){
		if( $(event.target).is('.cd-popup-close11') || $(event.target).is('.cd-popup11') ) {
			event.preventDefault();
	...
	$('.cd-popup12').on('click', function(event){
		if( $(event.target).is('.cd-popup-close12') || $(event.target).is('.cd-popup12') ) {
			event.preventDefault();
	...
	$('.cd-popup13').on('click', function(event){
		if( $(event.target).is('.cd-popup-close13') || $(event.target).is('.cd-popup13') ) {
			event.preventDefault();
	...
	$('.cd-popup14').on('click', function(event){
		if( $(event.target).is('.cd-popup-close14') || $(event.target).is('.cd-popup14') ) {
			event.preventDefault();
...
jQuery(document).ready(function($){
	...
	$('.cd-popup15').on('click', function(event){
		if( $(event.target).is('.cd-popup-close15') || $(event.target).is('.cd-popup15') ) {
			event.preventDefault();
	...
	$('.cd-popup17').on('click', function(event){
		if( $(event.target).is('.cd-popup-close17') || $(event.target).is('.cd-popup17') ) {
			event.preventDefault();
	...
	$('.cd-popup18').on('click', function(event){
		if( $(event.target).is('.cd-popup-close18') || $(event.target).is('.cd-popup18') ) {
			event.preventDefault();
	...
	$('.cd-popup19').on('click', function(event){
		if( $(event.target).is('.cd-popup-close19') || $(event.target).is('.cd-popup19') ) {
			event.preventDefault();
